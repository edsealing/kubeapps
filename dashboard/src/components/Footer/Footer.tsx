...
import logo from "../../EDCOPlogo.png";
          ...
          <div className="row collapse-b-phone-land align-center">
            <div className="col-6">
              <h4 className="inverse margin-reset">
                <img src={logo} alt="EDCOP logo" className="osFooter__logo" />
              </h4>
              <p className="type-color-white type-small margin-reset">
                Made with <Heart className="icon icon-small" />. Based on{" "}
                <a href="https://github.com/kubeapps/kubeapps" target="_blank">
                  KubeApps
                </a>.
              </p>
            </div>
            <div className="col-6 text-r">
              <a href="https://github.com/sealingtech/EDCOP" className="socialIcon margin-h-small">
                <svg
                  role="img"
                  aria-label="EDCOP on GitHub"
                  viewBox="0 0 54 54"
